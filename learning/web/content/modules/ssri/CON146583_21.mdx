...
<table>
 ...
 <tr>
  <td>
   <p>
    Other antidepressants—including duloxetine; MAOIs
    <sup>
     <a class="footnote-ref" href="#fn-2">
      2
     </a>
    </sup>
    (including moclobemide [specific for MAO-A] and older mixed MAO-A/B inhibitors such as phenelzine); St John’s wort; agomelatine; tricyclic antidepressants; tryptophan
   </p>
  </td>
  <td>
   <p>
 ...
 <tr>
  <td>
   <p>
    ...
    drugs (including aspirin, clopidogrel, dipyridamole, ticlopidine)
   </p>
  </td>
  <td>
   <p>
  ...
  <td>
   <p>
    If possible, avoid concomitant use; otherwise, also prescribe a gastroprotective medicine (such as a proton pump inhibitor
    <sup>
 ...
 <tr>
  ...
  <td>
   <p>
    Increased risk of CNS toxicity (convulsions, serotonin syndrome
    <sup>
