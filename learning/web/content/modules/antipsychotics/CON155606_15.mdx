...
Tardive dyskinesia is generally an uncommon but serious extrapyramidal side effect of antipsychotic use. Features of tardive dyskinesia[^1] typically appear some months or years after starting antipsychotic treatment (and when treatment is stopped). It is thought that tardive dyskinesia arises from increased sensitivity and abundance of striatal dopamine D2 receptors in response to chronic D2antagonism[^2].
