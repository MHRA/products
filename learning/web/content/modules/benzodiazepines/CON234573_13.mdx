...
<table>
 ...
 <tr>
  ...
  <td>
   ...
   <p>
    Combined disinhibitory[^6] effects of alcohol and a benzodiazepine may increase the possibility of aggressive behaviour.
   </p>
  </td>
  <td>
   <p>
    Warn individual of excessive sedation and psychomotor[^7] impairment.
   </p>
   <p>
 ...
 <tr>
  ...
  <td>
   <p>
    Warn individual of excessive sedation and psychomotor[^8] impairment
   </p>
  </td>
 </tr>
 <tr>
...
[^5]: A substance that blocks the effects of histamine. Histamine is released when the body mounts an immune response and it is responsible for many allergy-related symptoms


[^6]: Loss of inhibition which can lead to lack of restraint and disregard for social conventions


[^7]: Level of consciousness or cognitive ability linked to motor behaviour


[^8]: Level of consciousness or cognitive ability linked to motor behaviour
