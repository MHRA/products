...
Antipsychotics have serious and potentially irreversible adverse effects and, therefore, should be used for specific and serious indications—see [summary of licensed indications of antipsychotics for adults](../../assets/con185680.pdf). Over 7.7 million prescriptions for antipsychotics were dispensed in the community in England in 2011. Additionally, over 170 thousand prescriptions were dispensed for prolonged-release (‘depot’) injections of antipsychotics[^6].
