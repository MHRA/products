...
<Expander title="Did you know...">
 <p>
  ...
  </sup>. The antiemetic metoclopramide is an antagonist at the dopamine D<sub>2</sub> receptor. Great care is required if metoclopramide is given concurrently with an antipsychotic such as a phenothiazine because the combination increases the risk of extrapyramidal side effects.
  <sup>
