---
title: '3.2.2.4 Extrapyramidal side effects: tardive dyskinesia'
---

import Expander from '../../../src/components/Expander'

Tardive dyskinesia is generally an uncommon but serious extrapyramidal side effect of antipsychotic use. Features of tardive dyskinesia[^1] typically appear some months or years after starting antipsychotic treatment (and when treatment is stopped). It is thought that tardive dyskinesia arises from increased sensitivity and abundance of striatal dopamine D<sub>2</sub> receptors in response to chronic D<sub>2</sub>antagonism[^2].
