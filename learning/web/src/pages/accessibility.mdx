...
<span style="color: red">
  We need one of the following. Delete as appropriate.
</span>
...
<span style="color: red">
  We only need this section if there are non-compliances.
</span>
...
<span style="color: red">
  add link to explanation of how you decided which pages to test
</span>.
