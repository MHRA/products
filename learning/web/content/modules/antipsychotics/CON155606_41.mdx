...
Antipsychotics with significant antagonism at the muscarinic M<sub>1</sub> receptor can produce antimuscarinic (anticholinergic)[^1] effects which include blurred vision, constipation, urinary retention, sedation, memory impairment and sinus tachycardia.
